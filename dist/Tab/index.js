  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["title", "className", "isActive"]);

      return _react.default.createElement("li", _extends({
        className: (0, _classnames.default)('fur-tabs-tab', className, {
          'fur-tabs-tab-active': isActive
        })
      }, rest), _react.default.createElement("span", {
        className: "fur-tabs-tab-title"
      }, title));
    }
  }]);
