...
function (_React$Component) {
  ...
  function DateTimePicker() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "attachFlatpickr", function (props) {
      if (_this.flatpickr) _this.flatpickr.destroy();
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Input.default, _extends({}, rest, {
        inputRef: function inputRef(dateTimePicker) {
          return _this2.dateTimePicker = dateTimePicker;
        }
      })); // eslint-disable-line
    }
  }]);
