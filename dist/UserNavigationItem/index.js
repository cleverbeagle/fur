  ...
  (function(_React$Component) {
    ...
    function UserNavigationItem() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(UserNavigationItem)).call.apply(
          _getPrototypeOf2,
          [this].concat(args),
        ),
      );
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), 'toggleMenu', () => {
    ...
    _createClass(UserNavigationItem, [
      {
        ...
        value: function render() {
          ...
          const avatar = _this$props.avatar;
...
const _default = UserNavigationItem;
