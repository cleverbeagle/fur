...
var UserNavigationItem =
/*#__PURE__*/
function (_React$Component) {
  _inherits(UserNavigationItem, _React$Component);
  ...
  function UserNavigationItem() {
    ...
    _classCallCheck(this, UserNavigationItem);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(UserNavigationItem)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(UserNavigationItem, [{
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement("li", {
        className: (0, _classnames.default)('fur-navigation-item', 'fur-user-navigation-item', {
...
var _default = UserNavigationItem;
