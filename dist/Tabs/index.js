...
function (_React$Component) {
  ...
  function Tabs(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "validateChildrenAreTabs", function (children) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelectTab", function (activeTab) {
